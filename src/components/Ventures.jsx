...
const ventures = [
  {
    ...
    accent: '#2563EB',
    tagline: 'White-label support services for HighLevel agencies',
    description:
      'We provide done-for-you white-label support to agencies — building complex workflows, onboarding their clients under the agency brand, and delivering 24/7 support so agencies can scale without hiring.',
    stack: ['HighLevel', 'AI Agents', 'MCP Servers', 'A2P Verification', 'White Label', 'Automation'],
    features: [
      'Complex workflow building & management',
      'White-label client onboarding',
      'A2P verification & compliance setup',
      'AI Agents & MCP Server integrations',
      'Agency-branded HighLevel experience',
      '24/7 white-label support coverage',
    ],
  },
  {
    number: '02',
    ...
    description:
      'An end-to-end online ordering system for local restaurants and retailers, powered by HighLevel automations and custom checkout flows.',
    stack: ['HighLevel', 'Custom Checkout', 'Payments', 'Automation'],
    features: [
