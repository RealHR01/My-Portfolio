...
const ventures = [
  {
    ...
    description:
      'A fully managed white-label CRM platform built on HighLevel, enabling agencies to offer professional CRM services without the technical overhead.',
    stack: ['HighLevel', 'GHL Snapshots', 'White Label', 'Automation'],
    features: [
