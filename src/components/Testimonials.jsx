...
const testimonials = [
  ...
  { quote: "Our GHL sub-accounts were a mess. Hashir rebuilt the entire structure from scratch, fixed the broken automations, and delivered a full handoff doc. Clean, fast, thorough.", name: 'Jordan Ellis', role: 'SaaS Founder', company: 'NexusGrow', initials: 'JE', color: '#7C3AED', stars: 5 },
